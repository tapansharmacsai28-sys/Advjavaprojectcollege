...
public class Trade {
  ...
  public void revise(LocalDate date,String symbol,String side,BigDecimal quantity,BigDecimal entry,BigDecimal exit,BigDecimal leverage,BigDecimal risk,String notes){tradeDate=date;this.symbol=symbol.toUpperCase();this.side=side.toUpperCase();this.quantity=quantity;entryPrice=entry;exitPrice=exit;this.leverage=leverage;riskPercent=risk;this.notes=notes;}
